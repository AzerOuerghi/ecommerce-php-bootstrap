  ...
  <div class="container">
    <div class=" row">
      <div class="col-md-3 mb-4 ms-auto">
        <div>
          <a href="index.php">
            <img src="assets/img/logo.png" alt="main_logo" class="mb-2"  style="height: 50px; ">
          </a>
        </div>
        <div>
      ...
      <div class="col-md-2 col-sm-6 col-6 mb-4">
        <div>
          ...
          <ul class="flex-column ms-n3 nav">
            <li class="nav-item">
              <a class="nav-link" href="author.php #about" target="_blank">
                About Us
              </a>
            </li>
      ...
      <div class="col-md-2 col-sm-6 col-6 mb-4">
        <div>
          ...
          <ul class="flex-column ms-n3 nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="author.php" target="_blank">
                Knowledge Center
              </a>
            </li>
      ...
      <div class="col-12">
        <div class="text-center">
          <p class="text-dark my-4 text-sm font-weight-normal">
            All rights reserved. Copyright © <script>document.write(new Date().getFullYear())</script> Atlas <a href="author.php" target="_blank"></a>.
          </p>
        </div>
      </div>
    </div>
